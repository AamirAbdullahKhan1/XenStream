...
const Footer = () => {
  return (
    <footer class="bg-gray-800 text-gray-300 py-6 px-16 font-sans tracking-wide">
      <div class="flex justify-between items-center max-lg:flex-col text-center flex-wrap gap-4">
        <p class="text-[15px] leading-loose">© XenStream. All rights reserved.</p>
        ...
        <ul class="flex space-x-6 gap-y-2 max-lg:justify-center flex-wrap">
          ...
          <li><a href="javascript:void(0)" class="text-[15px] hover:text-white"><Link to='/contact'>Contact</Link></a></li>
        </ul>
      </div>
    </footer>
  )
